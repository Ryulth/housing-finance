...
public class PreProcessServiceTest {
    ...
    public void testMappingAmountOfYearByBankIdAndYear() {
        ...
        Map<String, Integer> resultMap = preProcessService.mappingAmountOfYearByBankIdAndYear(bankFinances);
    ...
    public void testListingFinanceStatus() {
        ...
        List<FinanceStatusByYear> resultList = preProcessService.listingFinanceStatus(bankFinanceMap, bankNameMap);
